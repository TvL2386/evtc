...
namespace GW2Scratch.ArcdpsLogManager.Logs
{
	public class LogFinder
	{
		...
		{
			var player1 = new LogPlayer("Testing player", ":Testing account.1234", 1, Profession.Thief, EliteSpecialization.Daredevil, "01D1DADF-751E-E411-ADEE-AC162DC0070D", 10000);
			var player2 = new LogPlayer("Testing player 2", ":Another account.1235", 1, Profession.Ranger, EliteSpecialization.Druid, "01D1DADF-751E-E411-ADEE-000000000000", 10000);
			var player3 = new LogPlayer("Testing player 3", ":ChronoGoddess.1236", 2, Profession.Mesmer, EliteSpecialization.Chronomancer, null, 10000);
